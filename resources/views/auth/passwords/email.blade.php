    ...
    <div class="d-md-flex flex-row-reverse">
        <div class="signin-right">
            <div class="signin-box">
                ...
                <h3 class="signin-title-secondary">Enter your email to get a reset link.</h3>
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('password.email') }}" data-parsley-validate>
                    ...
                    <button class="btn btn-primary btn-block btn-signin">Send Password Reset Link</button>
                </form>
            </div>
        </div><!-- signin-right -->
